        ...
        let fmtRouter = {
            ...
            component(resolve) {
                if (component.startsWith("Home")) {
                    ...
                    require(['../pages/commodity/' + component + '.vue'], resolve)
                } else if (component.startsWith("Ord")) {
                    require(['../pages/order/' + component + '.vue'], resolve)
                } else if (component.startsWith("Ope")) {
                    require(['../pages/operate/' + component + '.vue'], resolve)
                } else if (component.startsWith("Shop")) {
                    require(['../pages/shop/' + component + '.vue'], resolve)
                } else if (component.startsWith("User")) {
                    require(['../pages/user/' + component + '.vue'], resolve)
                } 
            },
            name: name,
            iconCls: iconCls,
